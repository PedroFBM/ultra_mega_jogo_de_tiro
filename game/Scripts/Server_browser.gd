...
onready var server_ip_text_edit = $Backgroung_panel/Server_ip_text_edit
onready var server_container = $Backgroung_panel/VBoxContainer
onready var manual_setup_button = $Backgroung_panel/Manual_setup
...
func _on_Manual_setup_pressed():
	if manual_setup_button.text != "Sair do setup":
		server_ip_text_edit.show()
		manual_setup_button.text = "Sair do setup"
		server_container.hide()
		server_ip_text_edit.call_deferred("grab_focus")
	else:
		server_ip_text_edit.text = ""
		server_ip_text_edit.hide() 
		manual_setup_button.text = "Conexão direta"
